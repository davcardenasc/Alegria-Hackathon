    ...
    <section id="aplicaciones" className="py-20">
      <div className="container mx-auto px-6 sm:px-8 lg:px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <Link href="https://tally.so/r/mByGRR" target="_blank" rel="noopener noreferrer">
            <div className="relative bg-gradient-to-br from-[#4A5EE7]/10 to-[#6366f1]/10 border-2 border-[#4A5EE7]/30 rounded-xl p-8 hover:border-[#4A5EE7]/60 hover:shadow-[0_0_30px_#4A5EE7/20] hover:scale-105 transition-all duration-300 cursor-pointer group overflow-hidden">
              ...
              <div className="text-center relative z-10">
                ...
                {/* Button indicator */}
                <div className="inline-flex items-center gap-2 bg-[#4A5EE7] text-white px-6 py-3 rounded-full font-semibold group-hover:bg-[#4A5EE7]/80 transition-colors font-body">
          ...
          <Link href="/formulario-colegios#top">
            <div className="relative bg-gradient-to-br from-[#BFC9DB]/10 to-[#4A5EE7]/10 border-2 border-[#BFC9DB]/30 rounded-xl p-8 hover:border-[#BFC9DB]/60 hover:shadow-[0_0_30px_#BFC9DB/20] hover:scale-105 transition-all duration-300 cursor-pointer group overflow-hidden">
              {/* Background decoration */}
              ...
              <div className="text-center relative z-10">
                ...
                {/* Button indicator */}
                <div className="inline-flex items-center gap-2 bg-[#BFC9DB] text-[#00162D] px-6 py-3 rounded-full font-semibold group-hover:bg-[#BFC9DB]/80 transition-colors font-body">
