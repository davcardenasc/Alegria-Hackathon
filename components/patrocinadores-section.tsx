        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
          {sponsors.map((sponsor, index) => (
            <div
              ...
              className={`bg-[#00162D] border border-[#4A5EE7]/20 rounded-lg p-6 text-center hover:border-[#4A5EE7]/40 hover:scale-105 transition-all duration-300 group relative ${
            ...
            >
              ...
              <h4 className="text-[#F7F9FF] font-bold text-lg mb-2">{sponsor.name}</h4>
              <p className="text-[#BFC9DB] text-sm">{sponsor.description}</p>
            </div>
          ))}
        </div>
      </div>
