...
const translations = {
  es: {
    ...
    "hero.subtitle": "Compite en el primer vibe-coding hackathon de la historia de Venezuela por $10,000+ en premios y lanza tu startup",
    "hero.subtitle_first_part": "Compite en el ",
    "hero.subtitle_highlight": "primer vibe-coding hackathon",
    "hero.subtitle_last_part": " de la historia de Venezuela por $10,000+ en premios y lanza tu startup",
    ...
    "prizes.description": "Más de $10,000 en premios esperándote",
    "prizes.first_place": "🥇 1er lugar",
    "prizes.second_place": "🥈 2do lugar",
    "prizes.third_place": "🥉 3er lugar",
    "prizes.top5": "⭐ Top 5 finalistas",
    "prizes.first_prize": "$2,000 USD por persona (hasta $8K)",
    "prizes.first_bonus": "+ MacBook Air M3",
    "prizes.second_prize": "$1,000 USD por persona (hasta $4K)",
    "prizes.second_bonus": "+ 1 año gratis de Lovable",
    "prizes.third_prize": "$500 USD por persona (hasta $2K)",
    "prizes.third_bonus": "+ 1 año gratis de Lovable",
    "prizes.top5_prize": "1 año gratis de Lovable",
    ...
    "overview.prizes.body": "Más de $10,000 en premios.\nPerks extra de software y equipo.",
  ...
  en: {
    ...
    "hero.subtitle": "Compete in Venezuela's first vibe-coding hackathon in history for $10,000+ in prizes and launch your startup",
    "hero.subtitle_first_part": "Compete in Venezuela's ",
    "hero.subtitle_highlight": "first vibe-coding hackathon",
    "hero.subtitle_last_part": " in history for $10,000+ in prizes and launch your startup",
    "hero.cta": "Apply now",
    ...
    // Prizes Section
    "prizes.title": "Prizes",
    "prizes.description": "Over $10,000 in prizes waiting for you",
    "prizes.first_place": "🥇 1st place",
    "prizes.second_place": "🥈 2nd place",
    "prizes.third_place": "🥉 3rd place",
    "prizes.top5": "⭐ Top 5 finalists",
    "prizes.first_prize": "$2,000 USD per person (up to $8K)",
    "prizes.first_bonus": "+ MacBook Air M3",
    "prizes.second_prize": "$1,000 USD per person (up to $4K)",
    "prizes.second_bonus": "+ 1 year free Lovable",
    "prizes.third_prize": "$500 USD per person (up to $2K)",
    "prizes.third_bonus": "+ 1 year free Lovable",
    "prizes.top5_prize": "1 year free Lovable",
    ...
    "overview.prizes.body": "Over $10,000 in prizes.\nExtra software and gear perks.",
