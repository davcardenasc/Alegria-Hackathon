...
const translations = {
  es: {
    ...
    "speakers.vicente.title": "CEO y Fundador de Yummy",
    "speakers.vicente.bio": "CEO y fundador de Yummy, la superapp líder de delivery y ridesharing en Venezuela",
    "speakers.vicente.full_bio": "Vicente Zavarce es un emprendedor dinámico y especialista en growth marketing, mejor conocido como el Fundador y CEO de Yummy, una ambiciosa super-app de e-commerce lanzada en Venezuela y ahora con sede en el Área de la Bahía. Valorada en más de $200 millones, Yummy opera en cuatro países, sirve a 4 millones de usuarios y completa alrededor de 800,000 órdenes cada mes.\n\nGraduado Magna Cum Laude de Northeastern University (B.S. en Finanzas y Emprendimiento, menor en Mercados Emergentes), Vicente perfeccionó sus habilidades en growth marketing en Wayfair, Getaround y Postmates antes de lanzar Yummy en 2020 como la primera app de delivery de Venezuela. Lo que comenzó como una plataforma de entrega de comida se ha expandido rápidamente a comestibles, rideshare y pronto pagos digitales, haciendo de Yummy una de las super-apps en ascenso de América Latina.\n\nA pesar de desafíos como la inestabilidad económica e hiperinflación en Venezuela, Vicente ha dirigido el rápido crecimiento de Yummy, construyendo una red de miles de comerciantes, millones de transacciones y decenas de miles de conductores en toda la región. También es reconocido por Forbes 30 Under 30 y es Socio en Epakon Capital, donde invierte en empresas de software en diversas industrias.",
    ...
    "speakers.talk2.description":
      "Aprende sobre growth marketing, adquisición de usuarios y estrategias para escalar startups desde Latinoamérica hacia mercados internacionales.",
  ...
  en: {
    ...
    "schedule.speakers_preview": "Vicente Zavarce, CEO of Yummy; Victor Cardenas, CEO of Slash ($400M Company)",
    ...
    "speakers.vicente.title": "CEO and Founder of Yummy",
    "speakers.vicente.bio": "CEO and founder of Yummy, the leading superapp for delivery and ridesharing in Venezuela",
    "speakers.vicente.full_bio": "Vicente Zavarce is a dynamic entrepreneur and growth-marketing specialist, best known as the Founder & CEO of Yummy, an ambitious e-commerce "super-app" launched in Venezuela and now based in the Bay Area. Valued at over $200 million, Yummy operates in four countries, serves 4 million users, and completes around 800,000 orders each month.\n\nA Magna Cum Laude graduate from Northeastern University (B.S. in Finance and Entrepreneurship, minor in Emerging Markets), Vicente sharpened his skills in growth marketing at Wayfair, Getaround, and Postmates before launching Yummy in 2020 as Venezuela's first delivery app. What began as a food-delivery platform has quickly expanded into groceries, rideshare, and soon digital payments, making Yummy one of Latin America's rising super-apps.\n\nDespite challenges such as economic instability and hyperinflation in Venezuela, Vicente has steered Yummy to rapid growth, building a network of thousands of merchants, millions of transactions, and tens of thousands of drivers across the region. He is also a Forbes 30 Under 30 honoree and a Partner at Epakon Capital, where he invests in software companies across industries.",
    "speakers.vicente.achievements": [
    ...
    "speakers.talk2.description":
      "Learn about growth marketing, user acquisition, and strategies for scaling startups from Latin America to international markets.",
