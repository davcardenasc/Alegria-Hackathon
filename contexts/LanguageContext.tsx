...
const translations = {
  es: {
    ...
    "speakers.vicente.full_bio": "Vicente Zavarce es un emprendedor y especialista en growth marketing que lidera Yummy, una startup con sede en el área de la Bahía de San Francisco. Graduado Magna Cum Laude de Northeastern University, Vicente ha demostrado habilidades empresariales excepcionales a través de diversos logros, incluyendo ser finalista Top 3 en la competencia de emprendimiento InnoWeekend. Con experiencia en entornos tecnológicos y de startups en San Francisco, es reconocido por su enfoque data-driven, espíritu empresarial y dedicación al trabajo. Vicente es multilingüe (español, inglés, portugués, francés) y tiene experiencia escalando bases de usuarios y gestionando presupuestos de marketing multimillonarios.",
    "speakers.vicente.achievements": [
      "CEO y fundador de Yummy, superapp líder en Venezuela",
      "Graduado Magna Cum Laude de Northeastern University",
      "Finalista Top 3 en InnoWeekend, competencia de emprendimiento",
      "Receptor del Dean's List por excelencia académica",
      "Especialista en growth marketing y adquisición de usuarios data-driven",
      "Experiencia gestionando presupuestos de marketing multimillonarios",
    ],
  ...
  en: {
    ...
    "speakers.vicente.full_bio": "Vicente Zavarce is an entrepreneur and growth marketing specialist who leads Yummy, a startup based in the San Francisco Bay Area. A Magna Cum Laude graduate from Northeastern University, Vicente has demonstrated exceptional entrepreneurial skills through various achievements, including being a Top 3 finalist at the InnoWeekend entrepreneurship competition. With experience in technology and startup environments in San Francisco, he is recognized for his data-driven approach, entrepreneurial spirit, and work dedication. Vicente is multilingual (Spanish, English, Portuguese, French) and has experience scaling user bases and managing multimillion-dollar marketing budgets.",
    "speakers.vicente.achievements": [
      "CEO and founder of Yummy, Venezuela's leading superapp",
      "Magna Cum Laude graduate from Northeastern University",
      "Top 3 finalist at InnoWeekend entrepreneurship competition",
      "Dean's List recipient for academic excellence",
      "Specialist in data-driven growth marketing and user acquisition",
      "Experience managing multimillion-dollar marketing budgets",
    ],
