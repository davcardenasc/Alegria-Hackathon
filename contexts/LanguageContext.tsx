...
const translations = {
  es: {
    ...
    "schedule.speakers_preview": "Vicente Zavarce (CEO de Yummy), Victor Cardenas (CEO de Slash), Pedro Vallenilla (CEO de Cashea)",
  ...
  en: {
    ...
    "schedule.speakers_preview": "Vicente Zavarce (CEO of Yummy), Victor Cardenas (CEO of Slash), Pedro Vallenilla (CEO of Cashea)",
