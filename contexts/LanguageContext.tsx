...
const translations = {
  es: {
    ...
    "hero.subtitle": "Compite en el primer hackatón de vibe-coding de la historia de Venezuela por $75,000+ en premios y lanza tu startup",
    "hero.subtitle_first_part": "Compite en el ",
    "hero.subtitle_highlight": "primer hackatón de vibe-coding",
    "hero.subtitle_last_part": " de la historia de Venezuela por $75,000+ en premios y lanza tu startup",
    ...
    "prizes.description": "Más de $75,000 en premios esperándote",
    ...
    "prizes.top5_bonus": "+ 2 tickets para SVS + Curso Intezia \"IA para negocios\"",
    ...
    "overview.prizes.body": "Más de $75,000 en premios.\nPerks extra de software y equipo.",
  ...
  en: {
    ...
    "hero.subtitle": "Compete in Venezuela's first vibe-coding hackathon in history for $75,000+ in prizes and launch your startup",
    "hero.subtitle_first_part": "Compete in Venezuela's ",
    "hero.subtitle_highlight": "first vibe-coding hackathon",
    "hero.subtitle_last_part": " in history for $75,000+ in prizes and launch your startup",
    "hero.cta": "Apply now",
    ...
    // Prizes Section
    "prizes.title": "Prizes",
    "prizes.description": "Over $75,000 in prizes waiting for you",
    ...
    "prizes.top5_bonus": "+ 2 SVS tickets + Intezia \"AI for Business\" course",
    ...
    "overview.prizes.body": "Over $75,000 in prizes.\nExtra software and gear perks.",
