...
const translations = {
  es: {
    ...
    "prizes.first_prize": "$1k por persona o Macbook Air M4 ($4k)",
    "prizes.first_bonus": "+ Pasantía en Cashea/Yummy",
    "prizes.second_prize": "$500 por persona",
    "prizes.second_bonus": "+ 1 año Suscripción Platzi",
    "prizes.third_prize": "$250 por persona",
  ...
  en: {
    ...
    "prizes.first_prize": "$1k per person or Macbook Air M4 ($4k)",
    "prizes.first_bonus": "+ Internship at Cashea/Yummy",
    "prizes.second_prize": "$500 per person",
    "prizes.second_bonus": "+ 1 year Platzi Subscription",
    "prizes.third_prize": "$250 per person",
