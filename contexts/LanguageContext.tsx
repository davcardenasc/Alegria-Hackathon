...
const translations = {
  es: {
    ...
    "hero.subtitle": "Compite en el primer vibe-coding hackathon de la historia de Venezuela por $22,500+ en premios y lanza tu startup",
    "hero.subtitle_first_part": "Compite en el ",
    "hero.subtitle_highlight": "primer vibe-coding hackathon",
    "hero.subtitle_last_part": " de la historia de Venezuela por $22,500+ en premios y lanza tu startup",
    ...
    "prizes.description": "Más de $22,500 en premios esperándote",
    ...
    "overview.prizes.body": "Más de $22,500 en premios.\nPerks extra de software y equipo.",
  ...
  en: {
    ...
    "hero.subtitle": "Compete in Venezuela's first vibe-coding hackathon in history for $22,500+ in prizes and launch your startup",
    "hero.subtitle_first_part": "Compete in Venezuela's ",
    "hero.subtitle_highlight": "first vibe-coding hackathon",
    "hero.subtitle_last_part": " in history for $22,500+ in prizes and launch your startup",
    "hero.cta": "Apply now",
    ...
    // Prizes Section
    "prizes.title": "Prizes",
    "prizes.description": "Over $22,500 in prizes waiting for you",
    ...
    "overview.prizes.body": "Over $22,500 in prizes.\nExtra software and gear perks.",
